...
class MerchantCustomerView(APIView):
    ...
    def post(self, request, format=None):     
        ...
        try:       
            ...
            checkcustomerphonedup= duplicatecustomerphonenumber(customerphonenumber,merchID)
            if checkcustomerphonedup is True:
    ...
    def put(self, request, format=None):
        ...
        try:
            ...
            customerupdate.DOB = request.data['DOB']
    ...
    def post(self,request,format=None):
        try: 
            ...
            if not(customerecord is None):
               ...
               responseData ={'message':'An error occur'+str(e),'status':'False'}
               return HttpResponse(json.dumps(responseData), content_type="application/json")
        responseData ={'message':'The redemption capture','status':'True'}
        return HttpResponse(json.dumps(responseData), content_type="application/json")
...
def duplicatecustomerphonenumber(customerphonenumber,merchID):
